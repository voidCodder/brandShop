...
$(function () {
    $('#MenSale').on('click', function () {
        window.location.assign('/category/1/');
    }) 
    $('#WomenSale').on('click', function () {
        window.location.assign('/category/2/');
    }) 
    $('#AccesoriesSale').on('click', function () {
        window.location.assign('/category/4/');
    }) 
    $('#KidsSale').on('click', function () {
        window.location.assign('/category/3/');
   }) 
});
/**
...
$(function () {
    ...
    $('#order-shipping-cont').on('click', function (e) {
        document.getElementsByClassName('ship-nav-item__block-wrap')[0].style.display = "none";
    ...
    //2.Shipping method
    $('#order-shipping-method-cont').on('click', function (e) {
    ...
    //3.Payment
    $('#order-payment-cont').on('click', function (e) {
